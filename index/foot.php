<footer>
		...
		<div id="login_reg">
			...
			<form id="login">
				<div id="register-active"><img src="../index/img_index/开关3.png" alt="" />切换注册</div>
				<h3>登录</h3>
				<p>
					<label class="icon" for="username"></label>
					<input class="input-control11" id="username" type="text" placeholder="请输入用户名" name="username" required="" aria-required="true">
					<span></span>
				</p>

				<p>
					<label class="icon" for="password"></label>
					<input class="input-control11" id="password" type="password" placeholder="请输入密码" name="passwd" required="" aria-required="true">
					<span></span>
				</p>
			...
			<form id="reg">
				<div id="login-active"><img src="../index/img_index/开关4.png" alt="" />切换登录</div>
				<h3>注册</h3>
				<p>
					<label class="icon" for="user_name"></label>
					<input class="input-control11" id="user_name" type="text" placeholder="请输入用户名" name="username" required="" aria-required="true">
					<span></span>
				</p>
				<p>
					<label class="icon" for="password"></label>
					<input class="input-control11" id="pass_word" type="password" placeholder="请输入密码" name="passwd" required="" aria-required="true">
					<span></span>
				</p>
				<p>
					<label class="icon" for="repass_word"></label>
					<input class="input-control11" id="repass_word" type="password" placeholder="再次输入密码"  required="" aria-required="true">
					<span></span>
				</p>
				<p>
